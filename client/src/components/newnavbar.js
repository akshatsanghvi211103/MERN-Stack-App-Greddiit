  ...
  return (
      <div className='navbar'>
        <ul className='nav'>
          ...
          <li className='items-nav'><Link to={`/${props.urlSubG}/users`} className='info-links new-links'>Users</Link></li>
          <li className='items-nav'><Link to={`/${props.urlSubG}/requests`} className='info-links new-links'>Join Requests</Link></li>
          <li className='items-nav'><Link to={`/${props.urlSubG}/stats`} className='info-links new-links'>Stats</Link></li>
          <li className='items-nav'><Link to={`/${props.urlSubG}/reports`} className='info-links new-links'>Reports</Link></li>
          ...
          <li className='items-nav'><Link to='/savedPosts' className='info-links'><BookmarkIcon fontSize='small' /> Saved</Link></li>
